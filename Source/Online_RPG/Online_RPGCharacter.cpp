...
void AOnline_RPGCharacter::OnHealthUpdate()
{
	...
	{
		FString healthMessage = FString::Printf(TEXT("누군가 피가 달았다."));
...
void AOnline_RPGCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &AOnline_RPGCharacter::Move);
...
void AOnline_RPGCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
