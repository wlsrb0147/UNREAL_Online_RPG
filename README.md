...
- 온라인 RPG를 제작하였습니다.
    ...
    캐릭터와 몬스터의 움직임, 이펙트와 아이템정보를 실시간 동기화하였습니다.
    
    서버는 Unreal Engine의 Listen Server를 사용하였습니다
    
    몬스터의 움직임은 Behavior tree
    
    캐릭터의 애니메이션은 State machine 을 사용하여 구현하였고
    
    아이템의 정보는 Data table를 통해 관리하였습니다.
    
    캐릭터의 정보는 Firebase에 저장하고 불러옵니다.
    
    제가 한 작업은 캐릭터와 NPC/아이템 상호작용, 인벤토리와 아이템 상태관리입니다.
